...
import { getOrderDetail, payOrder } from '../redux/actions/order';
...
const OrderScreen = () => {
  ...
  // console.log('OrderScreen-useEffect order: ', order);
  useEffect(() => {
      ...
      <div className="container">
        {loading ? (
          ...
          <>
                ...
                <div className="row">
                  ...
                  <div className="col-md-8 center">
                    ...
                    {order.isDelivered ? (
                      <div className="bg-info p-2 col-12">
                        <p className="text-white text-center text-sm-start">
                          Deliver on {moment(order.deliveredAt).calendar()}
                        </p>
                      </div>
                    ) : (
                      <div className="bg-danger p-2 col-12">
            ...
            <div className="row order-products justify-content-beetween">
                  ...
                  <>
                    {order.orderItems.map((item, index) => (
                      <div className="order-product row" key={index}>
                        ...
                        <div className="mt-3 mt-md-0 col-md-2 col-6 align-items-center d-flex flex">
                          <h4>SUBTOTAL</h4>
