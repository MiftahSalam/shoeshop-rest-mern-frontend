...
import { productAddReview, productDetails } from '../redux/actions/product';
import Loading from '../components/errors/Loading';
import Message from '../components/errors/Error';
import { PRODUCT_ADD_REVIEW_RESET } from '../redux/constants/product';
...
const SingleProductScreen = () => {
  ...
  const productReview = useSelector((state) => state.productAddReview);
  const {
  ...
  useEffect(() => {
    console.log('SingleProductScreen useEffect');
    if (successReview) {
